  ...
  <div class="flex flex-col h-screen bg-ink-900 overflow-hidden font-sans">
     ...
     <header class="flex-shrink-0 flex items-center justify-between px-6 h-14 border-b border-ink-800 bg-ink-900/80 backdrop-blur-md z-20">
       ...
       <div class="flex items-center gap-2">
         ...
         <span class="text-base font-extrabold tracking-tight font-display text-brand-yellow">
       ...
       <a
         ...
         target="_blank"
         rel="noopener noreferrer"
         class="flex items-center gap-2 text-xs font-medium text-zinc-400 hover:text-zinc-100 transition-colors duration-150 px-3 py-1.5 rounded-lg border border-ink-800 bg-ink-800/30 hover:bg-ink-800/80"
       >
