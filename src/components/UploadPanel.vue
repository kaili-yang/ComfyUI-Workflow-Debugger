...
<template>
  <div class="flex flex-col h-full bg-gray-950">
    <!-- Feature list -->
    <div class="flex-shrink-0 px-5 py-4 border-b border-gray-800 flex flex-col gap-2.5">
    ...
    <!-- Body -->
    <div class="flex-1 flex flex-col items-stretch justify-center px-5 py-6 gap-4 min-h-0">
      ...
      <template v-else>
        <div
          class="flex-1 min-h-0 border-2 border-dashed rounded-xl flex flex-col items-center justify-center gap-4 cursor-pointer transition-all duration-200 select-none"
          :class="isDragging
